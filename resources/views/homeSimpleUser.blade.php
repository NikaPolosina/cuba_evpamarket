                                ...
                                <div class="col-md-9">
                                    <div class="tab-content">
                                        <div id="tab_1-1" class="tab-pane active">
                                            <form role="form" action="/user/simple_user/setting/security/edit-simple"
                                                  method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{$userInfo->surname}}"
                                                           class="form-control" name="surname" required/>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Email</label>
                                                    <input type="text" value="{{$userInfo->getUser->email}}"
                                                           class="form-control" name="email" required/>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Улица</label>
                                                    <input type="text" value="{{$userInfo->street}}"
                                        ...
                                        <div id="tab_2-2" class="tab-pane">
                                            ...
                                            <form action="/avatar-uploader" role="form" method="post"
                                                    ...
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        ...
                                                        <div>
                                                            ...
                                                            <a href="javascript:;" class="btn default fileinput-exists"
                                                               data-dismiss="fileinput"> Отменить </a>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div id="tab_4-4" class="tab-pane">
                                            <form action="#">
                                                <table class="table table-bordered table-striped">
                                                    <tr>
                                                        <td> Возможность отправлять мне собщения от других
                                                            пользователей.
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td> Возможность просматривать мой профиль другими
                                                            пользователями.
                                                        </td>
                                                        <td>
                                                            <div class="mt-radio-inline">
