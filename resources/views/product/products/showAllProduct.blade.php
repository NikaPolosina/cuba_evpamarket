    ...
    $(function () {
        ...
        $(".number-spinner button").mousedown(function () {
            ...
            if (btn.attr('data-dir') == 'up') {
                ...
                console.log(parseInt(total_in_shop_origin));
                console.log(parseInt(total_in_shop_origin)+parseInt(input.val())-1);

                total_in_shop.html(parseInt(total_in_shop_origin)+parseInt(input.val())-1);
