...
class Order extends Model{
    ...
    protected $fillable = [ 'simple_user_id', 'hand', 'owner_user_id', 'status', 'total_price', 'discount_price', 'percent',  'order_phone', 'region', 'note', 'city', 'street', 'address', 'name', 'surname'];
