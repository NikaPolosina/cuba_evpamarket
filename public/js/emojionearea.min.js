...
!function (a, b, c) {
    ...
    var j = "data:image/gif;base64,R0lGODlhAQABAJH/AP///wAAAMDAwAAAACH5BAEAAAIALAAAAAABAAEAAAICVAEAOw==", k = [].slice, l = "emojionearea", m = 0, n = "&#8203;";
    ...
    b.getSelection && a.createRange ? (w = function (a) {
        ...
        if (c && c.rangeCount > 0) {
            var d = c.getRangeAt(0), e = d.cloneRange();
    ...
    function H(a) {
        ...
        if (!a.recent || a.recent !== b) {
            if (b.length) {
                var d = a.scrollArea.is(".skinnable"), e, f;
    ...
    function I(a, b) {
        var c = G(), d = c.split("|"), e = d.indexOf(b);
    ...
    function K(d, e, f) {
        f = v(f), d.sprite = f.sprite && m < 3, d.inline = null === f.inline ? e.is("INPUT") : f.inline, d.shortnames = f.shortnames, d.saveEmojisAs = f.saveEmojisAs, d.standalone = f.standalone, d.emojiTemplate = '<img alt="" class="emojione' + (d.sprite ? '-{uni}" src="' + j + '"/>' : 'emoji" src="{img}"/>'), d.emojiTemplateAlt = d.sprite ? '<i class="emojione-{uni}"/>' : '<img class="emojioneemoji" src="{img}"/>', d.emojiBtnTemplate = '<i class="emojibtn" role="button" data-name="{name}">' + d.emojiTemplateAlt + "</i>", d.recentEmojis = f.recentEmojis && J();
        var h = f.pickerPosition;
        d.floatingPicker = "top" === h || "bottom" === h;
        var i = e.is("TEXTAREA") || e.is("INPUT") ? "val" : "text", k, q, t, y, z, K, L, M, N, O = F({
        ...
        if (k.data(e.data()), c.each(f.attributes, function (a, b) {
                ...
                if ("recent" !== a || d.recentEmojis) {
                    if ("tones" !== a)c("<i/>", {
                        ...
                        "data-filter": a,
                        title: b.title
                    }).wrapInner(r(b.icon, d.emojiTemplateAlt)).appendTo(z); else {
                        if (!f.tones)return;
                        e = 5
                    }
                    do {
                        var g = F("category").attr({
                            name: a,
                            "data-tone": e
                        }).appendTo(L), h = b.emoji.replace(/[\s,;]+/g, "|");
        ...
        }), p(d, k, ["mousedown", "mouseup", "click", "keyup", "keydown", "keypress"]), p(d, t.find(".emojionearea-filter"), {click: "filter.click"});
        var Q = !1;
        if (N.on("scroll", function () {
                if (!Q && (D.call(d), N.is(":not(.skinnable)"))) {
                    var a = M.eq(0), b = N.offset().top;
                    M.each(function (d, e) {
                ...
                var c = M.filter('[name="' + a.data("filter") + '"]').offset().top, e = N.scrollTop(), f = N.offset().top;
                N.stop().animate({scrollTop: c + e - f - 2}, 200, "swing", function () {
                    D.call(d), Q = !1
                })
                ...
                var f = function (b) {
                    var e = "caret-" + (new Date).getTime(), f = A(b, d);
                    s(f), s('<i id="' + e + '"></i>'), a.scrollTop(i);
                    var g = c("#" + e), h = g.offset().top - a.offset().top, j = a.height();
                ...
                var h = w(a[0]), i = a.scrollTop(), j = c("<div/>", {contenteditable: !0}).css({
                    position: "fixed",
                    left: "-999px",
                    width: "1px",
                    height: "1px",
            ...
            var R = function () {
                var a = {maxCount: f.textcomplete.maxCount, placement: f.textcomplete.placement};
                ...
                b.sort(), k.textcomplete([{
                    id: l, match: /\B(:[\-+\w]*)$/, search: function (a, d) {
    ...
    var L = b.emojioneVersion || "2.1.4", M = {
